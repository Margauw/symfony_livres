<?php namespace Devschool\AdminBundle\Controller;
...
class AdminGenreController extends Controller
{
    ...
    {
        $genres = $this->getDoctrine()->getRepository('BiblioBundle:Genre')->findAll();
    ...
    public function editAction(Request $request, $id)
    {
        ...
        $genre = $this->getDoctrine()->getRepository('BiblioBundle:Genre')->find($id);
